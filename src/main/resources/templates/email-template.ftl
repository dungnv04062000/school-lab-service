...
<div class="content">
    Please click on the link below to complete the account registration process
</div>
<a class="link" href="http://ec2-54-179-147-207.ap-southeast-1.compute.amazonaws.com:3000/verify-account?userId=${userId}"
>Active account</a
>
